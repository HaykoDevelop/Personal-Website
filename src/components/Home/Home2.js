                ...
                <Row>
                    <Col md={8} className="home-about-description">
                        ...
                        <p className="home-about-body">
                            I have started my programming journey since 2019.
                            <br />
                            <br />
                            Since then i have finished multiple courses about
                            <i>
                            ...
                            <i>
                                <b className="purple">Websites</b> and learning
                                about new
                                <b className="purple"> Technologies. </b>
                            </i>
                            <br />
                        </p>
                    </Col>
